...
from thirdparty.Hexplane.scene.deformation import deform_network
from thirdparty.Hexplane.scene.regulation import compute_plane_smoothness
from torch.optim.lr_scheduler import ExponentialLR
from helper_model import getcolormodel


class HGaussianModel:
    ...
    def __init__(self, sh_degree : int, args ,rgbfunction="rgbv1"):
    ...
    def save_ply(self, path):
        ...
        attributes = np.concatenate((xyz, normals, f_dc, f_rest, opacities, scale, rotation, f_t, spacetime_mask), axis=1)
    ...
    def load_ply(self, path, spatial_lr_scale, init_mixprob, search=False):
        self.spatial_lr_scale = spatial_lr_scale
    ...
    def prune_points(self, mask, reset_mode=False):
        ...
        self._spacetime_mask = self._spacetime_mask[valid_points_mask]
        self._features_t = self._features_t[valid_points_mask]
    ...
    def prune_points_from_3DWeight(self, threshold):
        ...
        plt.title('Histogram of 4DGS 3D weights')
        plt.savefig('histogram_4DGS.png')
        plt.close() 
        '''
