...
class ModelHiddenParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.MoE_mean = False
        self.MoE_rotation = False
        self.MoE_opacity = False
        self.MoE_scale = False
        self.temp = False

        self.num_zero_expert = 0
        
        super().__init__(parser, "ModelHiddenParams")

class ModelEmbParams(ParamGroup):
    def __init__(self, parser):
        self.emb_net_width = 64
        self.emb_defor_depth = 1
        self.emb_min_embeddings = 30
        self.emb_max_embeddings = 150
        self.emb_no_ds=False
        self.emb_no_dr=False
        self.emb_no_do=True
        self.emb_no_dc=False
        self.emb_temporal_embedding_dim=256
        self.emb_gaussian_embedding_dim=32
        self.emb_use_coarse_temporal_embedding=False
        self.emb_no_c2f_temporal_embedding=False
        self.emb_no_coarse_deform=False
        self.emb_no_fine_deform=False
        self.emb_total_num_frames=300
        self.emb_c2f_temporal_iter=20000
        self.emb_deform_from_iter=0
        self.emb_use_anneal=True
        self.emb_zero_temporal=False
        # super().__init__(parser, "ModelEmbParams")
        super().__init__(parser, "ModelEmbParams")
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        # Embedding lr
        self.embnet_lr_init = 0.00016
        self.embnet_lr_final = 0.000016
        self.embnet_lr_delay_mult = 0.01
        self.embnet_lr_max_steps = 60_000
        ...
        # Routing weights
        self.weight_lr = 0.0025
        self.weight_movelr = 0.005
        self.weight_movelr_final = 0.0005
        self.gaiting_from_iter = 0
