...
class CameraInfo2():
    def __init__(self, uid, R, T, FovY, FovX, image_path, image_name, img_name, cam_image_dir, width, height, near, far, timestamp, emb_timestamp, fd_timestamp, pose, hpdirecitons, cxr, cyr, \
                 fd_FovY, fd_FovX, fd_fl_y, fd_fl_x, fd_cy, fd_cx, fd_R, fd_T):
        self.uid = uid
        self.R = R
        self.T = T
        self.FovY = FovY
