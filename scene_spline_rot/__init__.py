...
from scene_spline_rot.dataset_readers import sceneLoadTypeCallbacks
from scene_spline_rot.gaussian_model import GaussianModel
from scene_spline_rot.dataset import FourDGSdataset
from arguments import ModelParams
from utils.camera_utils import cameraList_from_camInfos, camera_to_JSON
from torch.utils.data import Dataset
from scene_spline_rot.dataset_readers import add_points

from scene_spline_rot.deform_model import DeformModel
...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], load_coarse=False):
        ...
        # self.video_cameras2 = FourDGSdataset(scene_info.video_cameras2, args, dataset_type)
        ...
        if self.loaded_iter:
            ...
            self.gaussians.load_embnet(os.path.join(self.model_path,
                            "point_cloud",
                            "iteration_" + str(self.loaded_iter),
                            ))
        else:
            self.gaussians.create_from_pcd(scene_info.point_cloud, self.cameras_extent, self.maxtime, self.duration)
    ...
    def save(self, iteration, stage):
        ...
        self.gaussians.save_embnet(point_cloud_path)
    ...
    # def getVideoCameras(self, scale=1.0):
    #     return self.video_cameras1, self.video_cameras2 