...
PathType = Union[Text, pathlib.PurePosixPath]  # pylint: disable=unsubscriptable-object
...
class Camera:
  ...
  def __init__(self,
               ...
               position: np.ndarray,
               focal_length: Union[np.ndarray, float],  # pylint: disable=unsubscriptable-object
               principal_point: np.ndarray,
               image_size: np.ndarray,
               skew: Union[np.ndarray, float] = 0.0,  # pylint: disable=unsubscriptable-object
               pixel_aspect_ratio: Union[np.ndarray, float] = 1.0,  # pylint: disable=unsubscriptable-object
               radial_distortion: Optional[np.ndarray] = None,  # pylint: disable=unsubscriptable-object
               tangential_distortion: Optional[np.ndarray] = None,  # pylint: disable=unsubscriptable-object
               dtype=np.float32):
